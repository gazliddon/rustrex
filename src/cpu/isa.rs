...
macro_rules! decode_op {
    ($op:expr, $this:ident, $mem:expr, $res:expr) => {
        match $op {
            0x00 =>  single_op!(direct, neg, $this, $mem, $res),
            0x03 =>  single_op!(direct, com, $this, $mem, $res),
            0x04 =>  single_op!(direct, lsr, $this, $mem, $res),
            0x06 =>  single_op!(direct, ror, $this, $mem, $res),
            0x07 =>  single_op!(direct, asr, $this, $mem, $res),
            0x08 =>  single_op!(direct, lsl_asl, $this, $mem, $res),
            0x09 =>  single_op!(direct, rol, $this, $mem, $res),
            0x0a =>  single_op!(direct, dec, $this, $mem, $res),
            0x0c =>  single_op!(direct, inc, $this, $mem, $res),
            0x0d =>  single_op!(direct, tst, $this, $mem, $res),
            0x0e =>  single_op!(direct, jmp, $this, $mem, $res),
            0x0f =>  single_op!(direct, clr, $this, $mem, $res),
            ...
            0x70 =>  single_op!(extended, neg, $this, $mem, $res),
            0x73 =>  single_op!(extended, com, $this, $mem, $res),
            0x74 =>  single_op!(extended, lsr, $this, $mem, $res),
            0x76 =>  single_op!(extended, ror, $this, $mem, $res),
            0x77 =>  single_op!(extended, asr, $this, $mem, $res),
            0x78 =>  single_op!(extended, lsl_asl, $this, $mem, $res),
            0x79 =>  single_op!(extended, rol, $this, $mem, $res),
            0x7a =>  single_op!(extended, dec, $this, $mem, $res),
            0x7c =>  single_op!(extended, inc, $this, $mem, $res),
            0x7d =>  single_op!(extended, tst, $this, $mem, $res),
            0x7e =>  single_op!(extended, jmp, $this, $mem, $res),
            0x7f =>  single_op!(extended, clr, $this, $mem, $res),
            ...
            0x90 =>  single_op!(direct, suba, $this, $mem, $res),
            0x91 =>  single_op!(direct, cmpa, $this, $mem, $res),
            0x92 =>  single_op!(direct, sbca, $this, $mem, $res),
            0x93 =>  single_op!(direct, subd, $this, $mem, $res),
            0x94 =>  single_op!(direct, anda, $this, $mem, $res),
            0x95 =>  single_op!(direct, bita, $this, $mem, $res),
            0x96 =>  single_op!(direct, lda, $this, $mem, $res),
            0x97 =>  single_op!(direct, sta, $this, $mem, $res),
            0x98 =>  single_op!(direct, eora, $this, $mem, $res),
            0x99 =>  single_op!(direct, adca, $this, $mem, $res),
            0x9a =>  single_op!(direct, ora, $this, $mem, $res),
            0x9b =>  single_op!(direct, adda, $this, $mem, $res),
            0x9c =>  single_op!(direct, cmpx, $this, $mem, $res),
            0x9d =>  single_op!(direct, jsr, $this, $mem, $res),
            0x9e =>  single_op!(direct, ldx, $this, $mem, $res),
            0x9f =>  single_op!(direct, stx, $this, $mem, $res),
            ...
            0xb0 =>  single_op!(extended, suba, $this, $mem, $res),
            0xb1 =>  single_op!(extended, cmpa, $this, $mem, $res),
            0xb2 =>  single_op!(extended, sbca, $this, $mem, $res),
            0xb3 =>  single_op!(extended, subd, $this, $mem, $res),
            0xb4 =>  single_op!(extended, anda, $this, $mem, $res),
            0xb5 =>  single_op!(extended, bita, $this, $mem, $res),
            0xb6 =>  single_op!(extended, lda, $this, $mem, $res),
            0xb7 =>  single_op!(extended, sta, $this, $mem, $res),
            0xb8 =>  single_op!(extended, eora, $this, $mem, $res),
            0xb9 =>  single_op!(extended, adca, $this, $mem, $res),
            0xba =>  single_op!(extended, ora, $this, $mem, $res),
            0xbb =>  single_op!(extended, adda, $this, $mem, $res),
            0xbc =>  single_op!(extended, cmpx, $this, $mem, $res),
            0xbd =>  single_op!(extended, jsr, $this, $mem, $res),
            0xbe =>  single_op!(extended, ldx, $this, $mem, $res),
            0xbf =>  single_op!(extended, stx, $this, $mem, $res),
            ...
            0xd0 =>  single_op!(direct, subb, $this, $mem, $res),
            0xd1 =>  single_op!(direct, cmpb, $this, $mem, $res),
            0xd2 =>  single_op!(direct, sbcb, $this, $mem, $res),
            0xd3 =>  single_op!(direct, addd, $this, $mem, $res),
            0xd4 =>  single_op!(direct, andb, $this, $mem, $res),
            0xd5 =>  single_op!(direct, bitb, $this, $mem, $res),
            0xd6 =>  single_op!(direct, ldb, $this, $mem, $res),
            0xd7 =>  single_op!(direct, stb, $this, $mem, $res),
            0xd8 =>  single_op!(direct, eorb, $this, $mem, $res),
            0xd9 =>  single_op!(direct, adcb, $this, $mem, $res),
            0xda =>  single_op!(direct, orb, $this, $mem, $res),
            0xdb =>  single_op!(direct, addb, $this, $mem, $res),
            0xdc =>  single_op!(direct, ldd, $this, $mem, $res),
            0xdd =>  single_op!(direct, std, $this, $mem, $res),
            0xde =>  single_op!(direct, ldu, $this, $mem, $res),
            0xdf =>  single_op!(direct, stu, $this, $mem, $res),
            ...
            0xf0 =>  single_op!(extended, subb, $this, $mem, $res),
            0xf1 =>  single_op!(extended, cmpb, $this, $mem, $res),
            0xf2 =>  single_op!(extended, sbcb, $this, $mem, $res),
            0xf3 =>  single_op!(extended, addd, $this, $mem, $res),
            0xf4 =>  single_op!(extended, andb, $this, $mem, $res),
            0xf5 =>  single_op!(extended, bitb, $this, $mem, $res),
            0xf6 =>  single_op!(extended, ldb, $this, $mem, $res),
            0xf7 =>  single_op!(extended, stb, $this, $mem, $res),
            0xf8 =>  single_op!(extended, eorb, $this, $mem, $res),
            0xf9 =>  single_op!(extended, adcb, $this, $mem, $res),
            0xfa =>  single_op!(extended, orb, $this, $mem, $res),
            0xfb =>  single_op!(extended, addb, $this, $mem, $res),
            0xfc =>  single_op!(extended, ldd, $this, $mem, $res),
            0xfd =>  single_op!(extended, std, $this, $mem, $res),
            0xfe =>  single_op!(extended, ldu, $this, $mem, $res),
            0xff =>  single_op!(extended, stu, $this, $mem, $res),
            ...
            0x1193 => single_op!(direct, cmpu, $this, $mem, $res),
            0x119c => single_op!(direct, cmps, $this, $mem, $res),
            0x11a3 => single_op!(indexed, cmpu, $this, $mem, $res),
            0x11ac => single_op!(indexed, cmps, $this, $mem, $res),
            0x11b3 => single_op!(extended, cmpu, $this, $mem, $res),
            0x11bc => single_op!(extended, cmps, $this, $mem, $res),
            ...
            0x1093 =>  single_op!(direct, cmpd, $this, $mem, $res),
            0x109c =>  single_op!(direct, cmpy, $this, $mem, $res),
            0x109e =>  single_op!(direct, ldy, $this, $mem, $res),
            0x109f =>  single_op!(direct, sty, $this, $mem, $res),
            ...
            0x10b3 =>  single_op!(extended, cmpd, $this, $mem, $res),
            0x10bc =>  single_op!(extended, cmpy, $this, $mem, $res),
            0x10be =>  single_op!(extended, ldy, $this, $mem, $res),
            0x10bf =>  single_op!(extended, sty, $this, $mem, $res),
            0x10ce =>  single_op!(immediate16, lds, $this, $mem, $res),
            0x10de =>  single_op!(direct, lds, $this, $mem, $res),
            0x10df =>  single_op!(direct, sts, $this, $mem, $res),
            0x10ee =>  single_op!(indexed, lds, $this, $mem, $res),
            0x10ef =>  single_op!(indexed, sts, $this, $mem, $res),
            0x10fe =>  single_op!(extended, lds, $this, $mem, $res),
            0x10ff =>  single_op!(extended, sts, $this, $mem, $res),
